...
```
> The highly correlated features in our dataset are Tax , cogs and gross.income.
...
```{r}
# we define a cutoff In order to make a decision,
library(FSelector)
...
```{r}
# set cutoff as a percentage to indicate we want to work with the percentage of the best variables.
...
```{r}
#  entropy - based approach as shown below;
...
> From our feature selection analysis we have derived our best features to look at would be Tax, cogs,gross.income and lastly the Unit price
